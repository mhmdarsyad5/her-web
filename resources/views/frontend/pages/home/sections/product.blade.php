<section
    class="py-8 sm:py-10 lg:py-12 bg-gradient-to-b from-white via-zinc-50/30 to-white relative overflow-hidden border-b border-zinc-200/80">
                                ...
                                <div class="flex flex-col flex-1 p-4 sm:p-5 relative">
                                    ...
                                    <div class="mt-6 flex flex-col gap-2 pt-4 border-t border-zinc-100/80">
                                        ...
                                        <a href="{{ $waUrl }}" target="_blank"
                                            class="inline-flex items-center justify-center gap-1.5 rounded-xl bg-green-600 hover:bg-green-700 text-white py-2 px-3.5 text-xs sm:text-sm font-semibold transition-all duration-200 sm:py-2.5 sm:px-4">
                                            <svg class="h-3.5 w-3.5 fill-current flex-shrink-0" viewBox="0 0 24 24"
                                        ...
                                        <a href="{{ route('products.show', $product->slug) }}"
                                            ...
                                            class="inline-flex items-center justify-center gap-1.5 rounded-xl text-white py-2 px-3 text-xs sm:text-sm font-semibold transition-all duration-200 hover:opacity-90 sm:py-2.5 sm:px-4">
                                            Lihat Detail Unit
                                        </a>
                                    </div>
                                </div>
