...
@section('content')
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-white via-zinc-50/20 to-white relative overflow-hidden">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <p class="mt-4 max-w-md
                               ...
                               leading-relaxed
                               text-zinc-600">
                        {{ strip_tags(setting('contact_description', 'Pertanyaan, masukan, atau peluang kolaborasi? Kirim pesan dan tim kami akan menghubungi Anda.')) }}
                    </p>
