                        ...
                        <div class="swiper-slide flex">
                            <article class="group flex flex-col w-full overflow-hidden rounded-2xl border
                                ...
                                <a href="{{ route('products.show', $product->slug) }}"
                                 ...
                                 {{-- Info Section --}}
                                 <div class="flex flex-col flex-1 p-2.5 sm:p-4 relative">
                                     <div class="flex-1">
                                         <a href="{{ route('products.show', $product->slug) }}">
                                             <h3
                                                 class="text-[11px] sm:text-base font-bold text-zinc-955 line-clamp-2 transition-colors group-hover:text-primary-900">
                                                 {{ $product->name }}
                                             </h3>
                                         </a>
                                         ...
                                         {{-- Tagline --}}
                                         @if($product->tagline)
                                             <p class="mt-1 text-[9px] sm:text-xs text-zinc-600 font-semibold leading-relaxed">
                                                 {{ $product->tagline }}
                                             </p>
                                         @endif
                                     </div>
                                     ...
                                     <div
                                         class="mt-2 sm:mt-2.5 space-y-1 bg-zinc-50/80 p-1.5 sm:p-2 rounded-lg sm:rounded-xl border border-zinc-100/80">
                                         {{-- Energy Spec --}}
                                         <div class="flex items-center justify-between text-[9px] sm:text-[11px] min-w-0">
                                             <div class="flex items-center gap-1.5 text-zinc-500">
                                                 <svg class="h-3 w-3 sm:h-3.5 sm:w-3.5 text-zinc-400 flex-shrink-0" fill="none"
                                         ...
                                         {{-- Height Spec --}}
                                         <div
                                             class="flex items-center justify-between text-[9px] sm:text-[11px] min-w-0 border-t border-zinc-200/40 pt-1.5 sm:pt-2">
                                             <div class="flex items-center gap-1.5 text-zinc-500">
                                                 <svg class="h-3 w-3 sm:h-3.5 sm:w-3.5 text-zinc-400 flex-shrink-0" fill="none"
                                                     viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                     <path stroke-linecap="round" stroke-linejoin="round"
                                         ...
                                         <div
                                             ...
                                             <div class="flex items-center gap-1.5 text-zinc-500">
                                                 ...
                                                 <span class="font-semibold text-zinc-500">Tipe Operator</span>
                                             </div>
                                             <span
                                                 class="font-bold text-zinc-800 text-right ml-2">{{ $product->operator_type ?: '-' }}</span>
                                         </div>
                                     </div>

                                     {{-- Actions (Matching mockup exactly) --}}
                                     <div class="mt-3 sm:mt-4 flex flex-col gap-1 sm:gap-1.5 pt-2.5 sm:pt-3 border-t border-zinc-100/80">
                                         @php
                                         ...
                                         <a href="{{ $waUrl }}" target="_blank"
                                             class="inline-flex items-center justify-center gap-1 sm:gap-1.5 rounded-lg sm:rounded-xl bg-green-600 hover:bg-green-700 text-white py-1.5 sm:py-2 px-2 sm:px-3 text-[9px] sm:text-xs font-bold transition-all duration-200">
                                             <svg class="h-2.5 w-2.5 sm:h-3 sm:w-3 fill-current flex-shrink-0" viewBox="0 0 24 24"
                                         ...
                                         <a href="{{ route('products.show', $product->slug) }}"
                                             ...
                                             class="inline-flex items-center justify-center gap-1 sm:gap-1.5 rounded-lg sm:rounded-xl text-white py-1.5 sm:py-2 px-2 sm:px-3 text-[9px] sm:text-xs font-bold transition-all duration-200 hover:opacity-90">
                                             Lihat Detail Unit
                                         </a>
                                     </div>
                                 </div>
